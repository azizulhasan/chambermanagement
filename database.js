export default defaultDatabse = {
  ...
  healthProfessionals: {
    madadiHasan: {
      ...
      image: process.env.CLIENT_URL + "/assets/front/images/corousel/1.jpeg",
    ...
    kamrulHasan: {
      ...
      image: process.env.CLIENT_URL + "/assets/front/images/corousel/2.jpeg",
    ...
    imranMasud: {
      ...
      image: process.env.CLIENT_URL + "/assets/front/images/corousel/3.jpeg",
      designation: "Psychological Counsellor, Mind to Heart",
      about:
