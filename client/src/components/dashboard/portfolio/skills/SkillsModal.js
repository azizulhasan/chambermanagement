...
export default function AboutModal({ setSkillsData, updateBton }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (data._id !== undefined) {
            postData(
                process.env.REACT_APP_API_URL + '/api/skills/' + data._id,
                data
            )
                .then((res) => {
                    setSkillsData(res);
    ...
    const getSkillsContent = (id) => {
        getData(process.env.REACT_APP_API_URL + '/api/skills/' + id).then(
            (res) => {
                setData(res);
                setLgShow(true);
            }
            ...
            >
                ...
                <Modal.Body>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group
                            className="mb-4"
                            controlId="skills.section_title"
                        >
