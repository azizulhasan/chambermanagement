...
export default function SummeryModal({ setSummeryData, updateBton }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (data._id !== undefined) {
            postData(
                process.env.REACT_APP_API_URL + '/api/summery/' + data._id,
                data
            )
                .then((res) => {
                    setSummeryData(res);
            ...
            >
                ...
                <Modal.Body>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group
                            className="mb-4"
                            controlId="summery.section_title"
                        >
                        ...
                        <Form.Group
                            className="mb-4"
                            controlId="summery.summery_title"
                        >
                        ...
                        <Form.Group
                            className="mb-4"
                            controlId="summery.education_title"
                        >
                        ...
                        <Form.Group
                            className="mb-4"
                            controlId="summery.experience_title"
                        >
                            <Form.Label>
