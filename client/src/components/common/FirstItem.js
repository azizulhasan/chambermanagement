                ...
                <>
                    ...
                    <TableTd classes={''}>
                        <div
                            ...
                            className="ctx-flex ctx-translate-x-1/3 ctx-w-96 ctx-bg-white ctx-py-2 ctx-my-3"
                        >
                            <div className="ctx-bg-white ctx-max-w-sm ctx-text-center">
                                ...
                                <h3 className="ctx-mt-2 ctx-text-sm ctx-font-medium ctx-text-gray-900">
                                    Create your first dynamic attribute
                                </h3>
                                <p className="ctx-mt-1 ctx-text-sm ctx-text-gray-500 ctx-py-2">
                                    Using Dynamic Attribute you can modify or
                                    change your product information easily with
                                    conditions.
                                </p>
                                <Button
                                    onClick={() => {
