...
const Pagination = () => {
    return (
        <nav className="ctx-flex ctx-items-center ctx-justify-between ctx-border-t ctx-border-gray-200 ctx-px-4 sm:ctx-px-0 ctx-mt-3">
            <div className="ctx--mt-px ctx-flex ctx-w-0 ctx-flex-1 ctx-pl-4">
                ...
                >
                    <ArrowLongLeftIcon
                        className="ctx-mr-3 ctx-h-5 ctx-w-5 ctx-text-gray-400"
                        aria-hidden="true"
                    />
                    Previous
                </a>
            ...
            <div className=" md:ctx--mt-px md:ctx-flex">
                ...
                <span className="ctx-inline-flex ctx-items-center ctx-border-t-2 ctx-border-transparent ctx-px-4 ctx-pt-4 ctx-text-sm ctx-font-medium ctx-text-gray-500">
                    ...
                </span>
                <a
                    href="wp-content/plugins/webappick-product-feed-for-woocommerce-pro/libs/webappick-product-feed-for-woocommerce/V5/src/components/common/Pagination#"
            ...
            <div className="ctx--mt-px ctx-flex ctx-w-0 ctx-flex-1 ctx-justify-end ctx-pr-6">
                ...
                >
                    Next
                    <ArrowLongRightIcon
                        className="ctx-ml-3 ctx-h-5 ctx-w-5 ctx-text-gray-400"
                        aria-hidden="true"
                    />
                </a>
            </div>
