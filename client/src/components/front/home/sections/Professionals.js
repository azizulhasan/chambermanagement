                    ...
                    return <div key={i} className="flex">
                        {
                            itemsInSingleSlide.map(index => {
                                return (< div key={index} style={{ width: perSlideWidth }} className={["flex-2 bg-white rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl pr-2",].join(' ')} >
                                    <img
