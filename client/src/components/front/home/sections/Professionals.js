...
const doctorInformation = [
    {id: uniqueId, specialist:"PHYCHOLOGIST", name: "Dr. Mr. Madadi Hasan", degree:"", img:'./assets/front/images/corousel/1.jpeg'},
    {id: uniqueId, specialist:"PHYCHOLOGIST", name: "Dr. Mr. Kamrul Hasan", degree:"", img:'./assets/front/images/corousel/2.jpeg'},
    {id: uniqueId, specialist:"PHYCHOLOGIST", name: "Dr. Mr. Imarn Masud", degree:"", img:'./assets/front/images/corousel/3.jpeg'},
    {id: uniqueId, specialist:"PHYCHOLOGIST", name: "Dr. Khadija Sultana", degree:"", img:'./assets/front/images/corousel/4.jpeg'},
    {id: uniqueId, specialist:"PHYCHOLOGIST", name: "Dr. Afifa Jahan", degree:"", img:'./assets/front/images/corousel/5.jpeg'},
...
const Professionals = () => {
  return (
    ...
    >
      <div className="professional gap-2">
          {
              doctorInformation?.map(item=>(
                ...
                />
                <div className="p-2">
                    <h2 className="font-bold text-md bg-themeColor text-white">{item.specialist}</h2>
        ...
        {/* <div>
          ...
          <p className="professional-legend">
