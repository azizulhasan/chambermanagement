    ...
    return (
        <>
            <div id={id} className=" my-10">
                <h1 className="text-2xl font-bold tracking-tight text-gray-900 pl-5">Resources</h1>
                <Carousel
                    autoPlay={false}
                    showArrows={true}
                    emulateTouch={true}
                            ...
                            return <div key={i} className="flex">
                                {
                                    itemsInSingleSlide.map(index => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <YoutubeEmbed classes={'rounded-t-lg'} title={resources[currentIndex].title} width={perSlideWidth} height={250} url={resources[currentIndex].url} />
