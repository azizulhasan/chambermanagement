...
export default function Home({ modalConfig = {} }) {
    ...
    return (
        <React.Fragment>
            ...
            {/* MODAL */}
            <div className="hidden p-1 mr-1 ml-1 mr-3 ml-3 hover:bg-gray-200 border-themeColor my-1 bg-[rgba(0,0,0,.5)] w-60 mx-2 px-2 col-span-4  py-4 mb-8 ml-16 ml-60 ml-96 bg-red-700 -ml-2 mr-2 sm:ml-10 md:ml-20 lg:ml-40 xl:ml-48 2xl:ml-60"></div>
            {/*LOADER*/}
