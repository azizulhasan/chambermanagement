...
export default function ContactModal({ setContactData, updateBton }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (data._id !== undefined) {
            postData(
                process.env.REACT_APP_API_URL + '/api/contact/' + data._id,
                data
            )
                .then((res) => {
                    setContactData(res);
    ...
    const getContactContent = (id) => {
        getData(process.env.REACT_APP_API_URL + '/api/contact/' + id).then(
            (res) => {
                setData(res);
                setLgShow(true);
            }
            ...
            >
                ...
                <Modal.Body>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group
                            className="mb-4"
                            controlId="contact.section_title"
                        >
                                        ...
                                        return (
                                            <Row key={i}>
                                                ...
                                                >
                                                    <Form.Group
                                                        className="mb-3"
                                                        controlId="contact.contact_type_value"
                                                    >
                                                        <Form.Label>
                                                            Contact Type Value
                                                        </Form.Label>
